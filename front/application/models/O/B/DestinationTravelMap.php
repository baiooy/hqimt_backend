<?php
class Application_Model_O_B_DestinationTravelMap extends Application_Model_O_B_Object{
	protected $_mgt='Application_Model_M_DestinationTravelMap';
    ...
    public function delete(){
        $where = 'id='.$this->getId();
        return Application_Model_M_DestinationTravelMap::delete($where);
    }
}
