...
class Yy_Upmp_Config
{
	...
	static $mer_id     				= "880000000001993"; // 商户号
	static $security_key    		= "bAPUOFB7iQhNI7X4AxnzpCe5Q9IPlhHW"; // 商户密钥
	static $mer_back_end_url     	= "http://www.yourdomain.com/your_path/yourBackEndUrl"; // 后台通知地址
	static $mer_front_end_url     	= "http://www.hqimt.com/"; // 前台通知地址
