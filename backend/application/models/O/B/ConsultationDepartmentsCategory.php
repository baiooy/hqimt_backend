<?php
class Application_Model_O_B_ConsultationDepartmentsCategory extends Application_Model_O_B_Object{
	protected $_mgt='Application_Model_M_ConsultationDepartmentsCategory';
